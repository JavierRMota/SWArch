...
class LightOnCommand < NoCommand
  #On value
  ON = 100
  #Off value
  OFF = 0
  ...
  #Execute action. Invokes light class action
  def execute
    @last_level = @light.level
    @light.on
  end
...
class LightOffCommand < NoCommand
  #On value
  ON = 100
  #Off value
  OFF = 0
...
class CeilingFanHighCommand < NoCommand
  ...
  #Execute action. Invokes fan class action
  def execute
    @last_speed = @fan.speed
    @fan.high
  end
...
class CeilingFanMediumCommand < NoCommand
...
class CeilingFanOffCommand < NoCommand
